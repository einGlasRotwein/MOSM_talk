...
opts_chunk$set(echo = FALSE, message = FALSE, warning = FALSE, fig.align = 'center', out.width = '80%')
```
...
```{r slide_inception, out.width = '90%'}
...
```{r slide_inception_bold, out.width = '90%'}
include_graphics("./pics/slide_inception.png")
```
...
```{r density_plot, out.width = '90%'}
nerd %>% 
  ggplot(aes(x = sum_score, fill = gender)) +
  geom_density(alpha = .5, binwidth = 2, position = "identity", size = 1) +
